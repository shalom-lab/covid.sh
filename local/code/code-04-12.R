...
# VARIABLE
v.date<-'2022-04-12'
v.url.case<-'https://mp.weixin.qq.com/s/SQoQiurUqYMz6xOvuBdVWw'
v.url.location<-'https://mp.weixin.qq.com/s/OZGM-pNkefZqWr0IFRJj1g'
...
# fill group
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,16,32),40)

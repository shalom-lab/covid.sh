...
# VARIABLE
v.date<-'2022-03-30'
v.url.case<-'https://mp.weixin.qq.com/s/iaU47C-9pA_amrrVRupb0w'
v.url.location<-'https://mp.weixin.qq.com/s/SSFVzOSXPTj-aLzR1tdtxw'
...
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,8,22),28)

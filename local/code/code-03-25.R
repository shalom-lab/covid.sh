...
# VARIABLE
v.date<-'2022-03-25'
v.url.case<-'https://mp.weixin.qq.com/s/xV7WBuu_7D9JA_D2mEOH_w'
v.url.location<-'https://mp.weixin.qq.com/s/XG03jIjQLLLjaJZ1DD-kAg'
...
df.case.1$group<-mf.tag(c('isolation','screen'),c(1,4),38)
df.asym.1$group<-mf.tag(c('isolation','screen'),c(1,1774),2231)

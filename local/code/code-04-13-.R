...
df.url<-df.url %>%
  bind_rows(c(v.date='2022-04-20',
            v.url.case='https://mp.weixin.qq.com/s/5LQeyprKrAgx__a9Ul037w',
            v.url.location='https://mp.weixin.qq.com/s/8qCvsE578Ehz6UcWYRBfXw')) %>%
...
# fill group
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,17,30),45)

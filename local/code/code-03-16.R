...
# VARIABLE
v.date<-'2022-03-16'
v.url <-'https://mp.weixin.qq.com/s/J8Ib1MFCWI6vouw5Gz2MiQ'
...
df.case.1$group<-mf.tag(c('isolation','screen'),c(1,2),7)
df.asym.1$group<-mf.tag(c('isolation','screen'),c(1,82),150)

names(df.case.1)
## add 病例3
df.case.1<-df.case.1 %>% add_row(t1='病例3',t2='女',t3='35岁',t4='居住于徐汇区田林八村',t5='',gender='女',age=35,address='徐汇区田林八村',district='徐汇区',date=as.Date('2022-03-16'),group='screen')

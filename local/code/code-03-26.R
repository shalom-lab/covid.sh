...
# VARIABLE
v.date<-'2022-03-26'
v.url.case<-'https://mp.weixin.qq.com/s/BJWNxy6RJ1vjTRLxjrT-eA'
v.url.location<-'https://mp.weixin.qq.com/s/JwUn4sVxSvHQs5KoyFn-lw'
...
df.case.1$group<-mf.tag(c('isolation','screen'),c(1,8),16)

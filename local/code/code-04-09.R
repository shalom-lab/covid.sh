...
# VARIABLE
v.date<-'2022-04-09'
v.url.case<-'https://mp.weixin.qq.com/s/s_Ylm-oTP-frivKUR6Wo_A'
v.url.location<-'https://mp.weixin.qq.com/s/_Je5_5_HqBcs5chvH5SFfA'
...
# fill group
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,10,26),41)

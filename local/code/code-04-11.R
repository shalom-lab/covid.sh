...
# VARIABLE
v.date<-'2022-04-11'
v.url.case<-'https://mp.weixin.qq.com/s/eun72mybh5Uy0k2m88ae_Q'
v.url.location<-'https://mp.weixin.qq.com/s/vxFiV2HeSvByINUlTmFKZA'
...
# fill group
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,10,23),38)

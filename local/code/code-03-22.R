...
# VARIABLE
v.date<-'2022-03-22'
v.url.case<-'https://mp.weixin.qq.com/s/63lyE8S-py-qPNs0hVidNA'
v.url.location<-'https://mp.weixin.qq.com/s/UUmzrx54vMdzZBKUm4uKfg'
...
df.case.1$group<-mf.tag(c('isolation','screen'),c(1,4),4)
df.asym.1$group<-mf.tag(c('isolation','screen'),c(1,887),977)

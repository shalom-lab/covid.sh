...
# VARIABLE
v.date<-'2022-03-21'
v.url.case<-'https://mp.weixin.qq.com/s/xvI3YyiqPJm-7E0AcfqtiA'
v.url.location<-'https://mp.weixin.qq.com/s/lqzf4il2Io1LXXf11PBN-A'
...
df.case.1$group<-mf.tag(c('isolation','screen'),c(1,31),31)
df.asym.1$group<-mf.tag(c('isolation','screen'),c(1,750),865)

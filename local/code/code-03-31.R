...
# VARIABLE
v.date<-'2022-03-31'
v.url.case<-'https://mp.weixin.qq.com/s/3RmzomqKwlXl0L_SAarnEg'
v.url.location<-'https://mp.weixin.qq.com/s/hnrGo4KvUvxhpjFyiE8-sQ'
...
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,5,20),29)

...
# VARIABLE
v.date<-'2022-03-13'
v.url <-'https://mp.weixin.qq.com/s/kdSUGd2xGR6Xx-HfekKUSA'
...
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,7,33),41)
df.asym.1$group<-mf.tag(c('isolation','screen','isolation','screen'),c(1,45,56,102),128)

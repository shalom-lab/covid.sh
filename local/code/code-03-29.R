...
# VARIABLE
v.date<-'2022-03-29'
v.url.case<-'https://mp.weixin.qq.com/s/ou48Io0NdHAzP6g89yp5Sg'
v.url.location<-'https://mp.weixin.qq.com/s/K6jT1wRMSScBhvxcB2yV4g'
...
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,7,22),28)

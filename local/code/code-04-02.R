...
# VARIABLE
v.date<-'2022-04-02'
v.url.case<-'https://mp.weixin.qq.com/s/K3KUe2X9Y0o9MrMg7hf4Ng'
v.url.location<-'https://mp.weixin.qq.com/s/2VWTo6e9gmWJ0vxeZ4PhIw'
...
# fill group
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,9,23),36)

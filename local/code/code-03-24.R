...
# VARIABLE
v.date<-'2022-03-24'
v.url.case<-'https://mp.weixin.qq.com/s/ERDsKlg9hev6H1PG__DAnw'
v.url.location<-'https://mp.weixin.qq.com/s/oBQXVicoi5tXuFt06ybsog'
...
df.case.1$group<-mf.tag(c('isolation','screen'),c(1,13),29)
df.asym.1$group<-mf.tag(c('isolation','screen'),c(1,1456),1580)

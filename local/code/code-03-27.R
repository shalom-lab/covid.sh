...
# VARIABLE
v.date<-'2022-03-27'
v.url.case<-'https://mp.weixin.qq.com/s/Qj1lyFPzCnAbR_EJBzFRIA'
v.url.location<-'https://mp.weixin.qq.com/s/MfBzdO0bG4fbokKTRCWuIw'
...
df.case.1$group<-mf.tag(c('isolation','screen'),c(1,3),12)

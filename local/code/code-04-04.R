...
# VARIABLE
v.date<-'2022-04-04'
v.url.case<-'https://mp.weixin.qq.com/s/EEtAYt7eskfNz4A-OuBIYA'
v.url.location<-'https://mp.weixin.qq.com/s/MkKsQkgvUWbwj8z9jG_Zng'
...
# fill group
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,9,24),25)

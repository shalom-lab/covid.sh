...
# VARIABLE
v.date<-'2022-03-20'
v.url.case<-'https://mp.weixin.qq.com/s/nVDL7sPkms09qai-LUsWeA'
v.url.location<-'https://mp.weixin.qq.com/s/s3FN7zk__wTz-jZM1c_lOg'
...
df.case.1$group<-mf.tag(c('isolation','screen'),c(1,23),24)
df.asym.1$group<-mf.tag(c('isolation','screen'),c(1,653),734)

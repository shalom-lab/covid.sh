...
# VARIABLE
v.date<-'2022-04-10'
v.url.case<-'https://mp.weixin.qq.com/s/FVqVXKK8EBnUe9sG1Gxq8g'
v.url.location<-'https://mp.weixin.qq.com/s/u0XfHF8dgfEp8vGjRtcwXA'
...
# fill group
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,11,26),34)

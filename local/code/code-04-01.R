...
# VARIABLE
v.date<-'2022-04-01'
v.url.case<-'https://mp.weixin.qq.com/s/-W3o-tlKXZFTBOGgSKnEwA'
v.url.location<-'https://mp.weixin.qq.com/s/gQDyFLtdILP2NuSBgcjUxg'
...
# fill group
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,5,19),20)

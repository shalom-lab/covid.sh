...
# VARIABLE
v.date<-'2022-03-17'
v.url <-'https://mp.weixin.qq.com/s/ZSIDH6G-IIrWUmXKpWGulg'
...
df.case.1$group<-mf.tag(c('isolation','screen'),c(1,3),57)
df.asym.1$group<-mf.tag(c('isolation','screen'),c(1,104),203)

...
# VARIABLE
v.date<-'2022-04-08'
v.url.case<-'https://mp.weixin.qq.com/s/FBRtpIMlQEDd8b7mbtYENw'
v.url.location<-'https://mp.weixin.qq.com/s/79NsKhMHbg09Y0xaybTXjA'
...
# fill group
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,9,25),40)

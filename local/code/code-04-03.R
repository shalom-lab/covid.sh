...
# VARIABLE
v.date<-'2022-04-03'
v.url.case<-'https://mp.weixin.qq.com/s/4BMkUSlU7DYdvgoLyMkYyQ'
v.url.location<-'https://mp.weixin.qq.com/s/uj4TYASUn2YJZQMg2aUvdw'
...
# fill group
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,6,21),32)

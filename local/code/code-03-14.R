...
# VARIABLE
v.date<-'2022-03-14'
v.url <-'https://mp.weixin.qq.com/s/15EJxTQ-lmatQhze30R9-g'
...
df.case.1$group<-mf.tag(c('screen','isolation'),c(1,5),9)
df.asym.1$group<-mf.tag(c('isolation','screen','isolation','screen'),c(1,26,35,112),129)

## add 无症状 75
names(df.asym.1)
df.asym.1<-df.asym.1 %>% add_row(t1='病例75',t2='女',t3='25岁',t4='',t5='',gender='女',age=35,address='徐汇区',district='徐汇区',date=as.Date('2022-03-14'),group='isolation')

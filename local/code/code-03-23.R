...
# VARIABLE
v.date<-'2022-03-23'
v.url.case<-'https://mp.weixin.qq.com/s/hhszboYJIwWBwUl3eTu-bA'
v.url.location<-'https://mp.weixin.qq.com/s/XL_hz8ESYGM8ZW7FQuHFRA'
...
df.case.1$group<-mf.tag(c('isolation'),c(1),4)
df.asym.1$group<-mf.tag(c('isolation','screen'),c(1,879),979)

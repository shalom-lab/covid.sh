...
# VARIABLE
v.date<-'2022-03-28'
v.url.case<-'https://mp.weixin.qq.com/s/b50xlqsNgcvuw8JbILsJVw'
v.url.location<-'https://mp.weixin.qq.com/s/656rotFOMeDScnKSt6OmyQ'
...
df.case.1$group<-mf.tag(c('isolation','screen','asym'),c(1,3,15),21)
